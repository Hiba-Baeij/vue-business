            ...
            <div class="svg">
              ...
              >
                <path
                  ...
                  transform="translate(-118.66231 -178.18943)"
                  fill="#ffb6b6"
                />
                <path
                ...
                />
                <polygon
                  points="26.276 533.887 35.034 533.886 39.2 500.107 26.274 500.107 26.276 533.887"
                  fill="#a0616a"
                />
                <path
                ...
                />
                <polygon
                  points="60.214 528.368 68.756 530.297 80.261 498.265 67.653 495.418 60.214 528.368"
                  fill="#a0616a"
                />
                <path
            ...
            <b-row class="circle">
              ...
              >
                <div
                  ...
                  "
                >
                  <span class="mdi mdi-head-dots-horizontal-outline"></span>
                </div>
              </b-col>
              <b-col lg="9" sm="9">
                <div class="text-feature">
                  ...
                  <p>
                    ...
                    Eveniet minus blanditiis doloribus illum tempore, tenetur
                    molestiae aliquam eos, quibusdam ullam numquam
                  </p>
                </div>
              </b-col>
            </b-row>
            <b-row class="unvertical">
              <b-col
                lg="3"
                sm="3"
                class="circle d-flex justify-content-center align-items-center"
