      ...
      <b-row>
        ...
        <b-col lg="6">
          ...
          <p>
            ...
            suscipit et deserunt ipsam corrupti aut ullam, error totam fuga eos?
            Molestiae inventore iste minus nulla eveniet, deserunt cum dolore
            sint Lorem ipsum dolor sit amet consectetur adipisicing elit.
            Voluptates, distinctio voluptatum nostrum odit ducimus perferendis
            quisquam quis suscipit ipsum maiores, et harum consequatur
            quibusdam? Fugit officia dolorum temporibus dicta eos!
          </p>
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. A maiores
            iste dicta corrupti molestiae alias dolorum laborum repellendus
            magni velit, aut sit, atque ab pariatur, laudantium natus ea omnis
            ipsum!
          </p>

          <h3>CEO Jhone Doe</h3>
          <b-button to="/about" variant="transparent "
            ><span class="share mdi mdi-chevron-right"></span> Learn
            More</b-button
          >
        </b-col>
      </b-row>
...
.about:hover {
  #progress1 {
    animation: progress all 2s ease;
  }
  #progress2 {
    animation: progress all 2s ease;
  }
